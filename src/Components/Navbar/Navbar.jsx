            ...
            <a className="navbar-brand" href="https://translate.google.com/"><img src={icon} alt=".."  height="50px"/></a>
                ...
                <div className="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                            <a className="nav-link text-white mr-5  mt-3" href="https://translate.google.com/"><i className="fas fa-globe"></i> EN <i className="fas fa-chevron-down"></i></a>
                        </li>
                        <li className="nav-item">
                            <span className="nav-link text-white mt-3 togSty">
                                <i className="fas fa-user-alt mx-3 fa-lg"></i>
                                <i className="far fa-bell fa-lg"></i>
                                <i className="fas fa-shopping-cart mx-3 fa-lg"></i>
